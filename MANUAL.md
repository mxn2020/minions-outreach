# Manual Setup Steps for Minions Outreach
...
Go to **GitHub → mxn2020/minions-outreach → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-outreach` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-outreach-web`
- **GitHub repo**: `mxn2020/minions-outreach`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `outreach.minions.wtf`

### Documentation
- **Netlify site name**: `minions-outreach-docs`
- **GitHub repo**: `mxn2020/minions-outreach`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `outreach.minions.help`

### Blog
- **Netlify site name**: `minions-outreach-blog`
- **GitHub repo**: `mxn2020/minions-outreach`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `outreach.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `outreach.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `outreach.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `outreach.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-outreach/sdk`](https://www.npmjs.com/package/@minions-outreach/sdk)
- CLI: [`@minions-outreach/cli`](https://www.npmjs.com/package/@minions-outreach/cli)
...
Your package: [`minions-outreach`](https://pypi.org/project/minions-outreach/)
...
| Item | Value |
|------|-------|
| Project | `minions-outreach` |
| SDK (npm) | `@minions-outreach/sdk` |
| CLI (npm) | `@minions-outreach/cli` |
| Python (PyPI) | `minions-outreach` |
| GitHub | `github.com/mxn2020/minions-outreach` |
| Docs domain | `outreach.minions.help` |
| Blog domain | `outreach.minions.blog` |
| App domain | `outreach.minions.wtf` |
