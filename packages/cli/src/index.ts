...
/**
 * @minions-outreach/cli — CLI for Minions Outreach
 *
...
import { customTypes } from '@minions-outreach/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Outreach'));
        console.log(chalk.dim('Email templates, drip sequences, personalization rules, and send schedules'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-outreach/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-outreach/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-outreach')}`);
